...
const App = () => {
  ...
  useEffect(()=>{
          axios.get("https://mychoice-server.vercel.app/mychoice/products")
          .then((res)=>{
  ...
  //cart products info
  useEffect(()=>{
      axios.post(`https://mychoice-server.vercel.app/mychoice/product/ids`,{ids:cart})
      .then((res)=>{
          setData(res.data)
      })
      .catch((err)=>{
  ...
  //all cart ids
  useEffect(()=>{
    axios.get(`https://mychoice-server.vercel.app/mychoice/users/carts/${user}`)
    .then((res)=>{
        setCart(res.data);
    })
    .catch((err)=>{
